...
const RestaurantMenuClient = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#E59A01] via-[#F5A623] to-[#E59A01] font-sans text-gray-800 relative overflow-hidden">
      ...
      <div className="relative h-[75vh] md:h-[85vh] bg-gray-900 overflow-hidden">
        ...
        >
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="mb-6">
              ...
              <div className="h-1.5 w-32 bg-linear-to-r from-[#D92E2E] via-[#FF6B6B] to-transparent rounded-full"></div>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap mb-6">
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-linear-to-r from-yellow-400 to-orange-500 rounded-full blur-lg opacity-50 group-hover:opacity-75 transition-opacity"></div>
                <div className="relative flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300">
                  <span className="text-2xl font-black bg-linear-to-r from-yellow-500 to-orange-600 bg-clip-text text-transparent">
                    {restaurant.rating}
                  </span>
              ...
              {/* Price Badge */}
              {restaurant.price && (
                <div className="px-6 py-3 bg-linear-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-md rounded-full text-base font-bold text-white border-2 border-green-400/30 shadow-xl hover:scale-105 transition-all duration-300">
                  💰 {restaurant.price}
                </div>
              )}
              ...
              {restaurant.trending && (
                <div className="px-6 py-3 bg-linear-to-r from-[#D92E2E] to-[#FF6B6B] rounded-full text-base font-bold text-white shadow-xl animate-pulse">
                  🔥 Trending
                </div>
              )}
            </div>
        ...
        {/* Bottom Fade Effect */}
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-linear-to-t from-[#E59A01] to-transparent"></div>
      </div>
                ...
                <button
                  ...
                  className={`px-8 py-4 rounded-2xl font-bold whitespace-nowrap transition-all duration-500 transform hover:scale-105 ${
                    selectedCategory === category
                      ? "bg-linear-to-r from-[#D92E2E] to-[#FF6B6B] text-white shadow-[0_10px_30px_rgba(217,46,46,0.5)] scale-105"

    ...
    <div className="relative">
      ...
      <div className="relative z-10 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-r from-green-400/10 to-emerald-600/10 backdrop-blur-md p-6 rounded-2xl border border-green-400/20">
          ...
          <div className="bg-yellow-400/10 backdrop-blur-md p-6 rounded-2xl border border-yellow-400/20">
            <p className="text-yellow-200 text-sm font-medium mb-1">Pending</p>
          ...
          <div className="bg-red-400/10 backdrop-blur-md p-6 rounded-2xl border border-red-400/20">
            <p className="text-red-200 text-sm font-medium mb-1">Refunded</p>
            <p className="text-white text-3xl font-bold">{stats.refunded}</p>
          </div>
        </div>
